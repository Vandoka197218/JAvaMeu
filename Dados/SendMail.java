...
import br.com.playservice.telas.*;
...
class SendMail {
        ...
        private final String EMAIL_ORIGEM = "tecnica.consertado.playservice@gmail.com";
    private final String SENHA = "va12do34";
    ...
    public void sendMail(String from, String to, String subject, String message) {
        ...
        /*
         ...
         props.setProperty("socksProxyHost","192.168.255.2"); // IP do Servidor Proxy 
        ...
        auth = new SimpleAuth(EMAIL_ORIGEM, SENHA);
        ...
        try {
             ...
             */
            tr.connect(mailSMTPServer, EMAIL_ORIGEM, SENHA);
            msg.saveChanges(); // don't forget this  
            //envio da mensagem  
            tr.sendMessage(msg, msg.getAllRecipients());
            System.out.println(">>> :)Mensagem Enviada com Exito Fechando Conexão ");
